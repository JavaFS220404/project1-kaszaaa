...
public class ReimbursementServiceTest {
	...
	public void setUp() throws Exception {
		GENERIC_EMPLOYEE_1 = new User(1, "genericEmployee1", "genericPassword", Role.EMPLOYEE, null, null, null, 0);
		GENERIC_FINANCE_MANAGER_1 = new User(1, "genericManager1", "genericPassword", Role.FINANCE_MANAGER, null, null, null, 0);
